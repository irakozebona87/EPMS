...
export default function Navbar() {
  ...
  const linkClass = ({ isActive }) =>
    `flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs font-semibold uppercase tracking-wider ${
      isActive
      ...
      <div className="max-w-7xl mx-auto px-6 py-2.5 flex flex-wrap items-center gap-2.5">
        {loggedIn ? (
          <>
            ...
            <button 
              onClick={logout} 
              className="ml-auto flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-xs font-semibold uppercase tracking-wider bg-rose-600/90 text-white border border-rose-500 hover:bg-rose-700 hover:border-rose-600 transition-all duration-200 shadow-md shadow-rose-900/10 cursor-pointer"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
